...
public class NewsManagement2TestDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    public NewsManagement2TestDataSeedContributor(IGuidGenerator guidGenerator,
